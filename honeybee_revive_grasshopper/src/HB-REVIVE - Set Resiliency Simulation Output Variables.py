...
ghenv.Component.Name = "HB-REVIVE - Set Resiliency Simulation Output Variables"
DEV = honeybee_revive_rhino._component_info_.set_component_params(ghenv, dev=False)
if DEV:
    from honeybee_revive_rhino.gh_compo_io.adorb import set_resiliency_output_variables as gh_compo_io
    reload(gh_compo_io)
...
# ------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_SetResiliencySimulationOutputVariables(
        IGH,
        base_sim_output_,
)
