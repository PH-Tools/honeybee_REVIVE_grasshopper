...
EM September 20, 2024
    Args:
        _measuere_names: (list[str]) The name or names of the Measures to search the 
...
ghenv.Component.Name = "HB-REVIVE - Load REVIVE CO2-Measures from Standards Library"
