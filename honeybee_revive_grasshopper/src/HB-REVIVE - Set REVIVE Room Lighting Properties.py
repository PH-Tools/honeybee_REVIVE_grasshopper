...
ghenv.Component.Name = "HB-REVIVE - Set REVIVE Room Lighting Properties"
DEV = honeybee_revive_rhino._component_info_.set_component_params(ghenv, dev=False)
if DEV:
    from honeybee_revive_rhino.gh_compo_io.equipment import lighting_set_room_properties as gh_compo_io
    reload(gh_compo_io)
