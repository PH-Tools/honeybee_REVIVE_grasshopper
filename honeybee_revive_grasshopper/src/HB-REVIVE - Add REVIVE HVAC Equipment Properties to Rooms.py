...
EM September 21, 2024
    Args:
        ...
        _hb_rooms: (list[Room]) The Honeybee-Rooms to add the new Phius-REVIVE
            HVAC-Properties to.

    Returns:
        hb_rooms_: (list[Room]) The Honeybee-Rooms with the Phius-REVIVE HVAC
            Equipment Properties added. 
"""
...
# ------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_AddHvacEquipmentPropertiesToRooms(
        IGH,
