...
#
"""
Output graphs of the calculated ADORB cost values.
-
EM November 15, 2024
    Args:
        _adorb_costs_csv: The CSV file with the ADORB costs to graph
...
ghenv.Component.Name = "HB-REVIVE - Generate ADORB Output Graphs"
DEV = honeybee_revive_rhino._component_info_.set_component_params(ghenv, dev=False)
if DEV:
    from honeybee_revive_rhino.gh_compo_io.adorb import generate_graphs as gh_compo_io
    reload(gh_compo_io)
...
# ------------------------------------------------------------------------------
gh_compo_interface = gh_compo_io.GHCompo_GenerateADORBGraphs(
        False,
        IGH,
        _adorb_costs_csv,
        _folder_,
