...
def run_winter_graph_generator(_sql_path, _results_folder_path, *args, **kwargs):
    ...
    if not os.path.isdir(_results_folder_path):
    ...
    commands = [
        ...
        py3_script_filepath,  # --------- The python3-script to run
...
class GHCompo_CreateResiliencyOutputFiles(object):
    ...
    def run(self):
        ...
        stdout, stderr, results_folder_path = run_winter_graph_generator(
