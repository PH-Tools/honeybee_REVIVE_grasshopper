...
"""GH-Component Interface: HB-REVIVE - Set ADORB Simulation Output Variables."""
...
class GHCompo_SetADORBSimulationOutputVariables(object):
    ADORB_simulation_outputs = [
    ...
    def run(self):
        ...
        for output_name in self.ADORB_simulation_outputs:
