...
class GHCompo_CreateReviveResidentialProgram(object):
    icfa_m2 = ghio_validators.UnitM2("icfa_m2", 0)
    number_bedrooms = ghio_validators.IntegerPositiveValueOrZero("number_bedrooms", 0)
    number_dwellings = ghio_validators.IntegerPositiveValueOrZero("number_dwellings", 1)
